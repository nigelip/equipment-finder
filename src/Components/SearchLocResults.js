  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (querySnapshot) => {
      ...
      querySnapshot.forEach((doc) => {
        if (doc.data().target === "Back") backItems.push(doc.data());
        else if (doc.data().target === "Legs") legsItems.push(doc.data());
        else if (doc.data().target === "Chest") chestItems.push(doc.data());
        else if (doc.data().target === "Arms") armsItems.push(doc.data());
        else if (doc.data().target === "Glutes") glutesItems.push(doc.data());
        ...
        else if (doc.data().target === "Core") coreItems.push(doc.data());
      });
